...
export const impuestosTool: Tool = {
  name: 'get_impuestos',
  description: 'Obtener impuestos con paginación y filtros',
  inputSchema: {
    type: 'object',
    properties: {
      limit: {
...
export async function handleImpuestosTool(
  ...
  try {
    const result = await client.getWithPagination<Impuesto>(
      '/impuestos',
      limit,
      offset,
      additionalParams
