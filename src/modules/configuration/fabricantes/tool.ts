...
export const fabricantesTool: Tool = {
  name: 'get_fabricantes',
  description: 'Obtener fabricantes con paginación y filtros',
  inputSchema: {
    type: 'object',
    properties: {
      limit: {
...
export async function handleFabricantesTool(
  ...
  try {
    const result = await client.getWithPagination<Fabricante>(
      '/fabricantes',
      limit,
      offset,
      additionalParams
