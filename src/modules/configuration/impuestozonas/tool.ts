...
export const impuestozonasTool: Tool = {
  name: 'get_impuestozonas',
  description: 'Obtener zonas de impuestos con paginación y filtros',
  inputSchema: {
    type: 'object',
    properties: {
      limit: {
...
export async function handleImpuestozonasTool(
  ...
  try {
    const result = await client.getWithPagination<ImpuestoZona>(
      '/impuestozonas',
      limit,
      offset,
      additionalParams
