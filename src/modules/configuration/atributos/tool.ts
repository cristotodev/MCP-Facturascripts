...
export const atributosTool: Tool = {
  name: 'get_atributos',
  description: 'Obtener atributos de productos con paginación y filtros',
  inputSchema: {
    type: 'object',
    properties: {
      limit: {
...
export async function handleAtributosTool(
  ...
  try {
    const result = await client.getWithPagination<Atributo>(
      '/atributos',
      limit,
      offset,
      additionalParams
