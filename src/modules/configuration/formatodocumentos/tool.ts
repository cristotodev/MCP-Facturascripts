...
export const formatodocumentosTool: Tool = {
  name: 'get_formatodocumentos',
  description: 'Obtener formatos de documentos con paginación y filtros',
  inputSchema: {
    type: 'object',
    properties: {
      limit: {
...
export async function handleFormatodocumentosTool(
  ...
  try {
    const result = await client.getWithPagination<FormatoDocumento>(
      '/formatodocumentos',
      limit,
      offset,
      additionalParams
