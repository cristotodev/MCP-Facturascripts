export const toolDefinition = {
  ...
  description: 'Obtiene los pedidos de proveedores del sistema FacturaScripts con soporte para filtrado dinámico y paginación.',
  inputSchema: {
    type: 'object',
    properties: {
      limit: {
...
export const toolImplementation = async (resource: any, buildUri: Function) => {
  const uri = buildUri('pedidoproveedores');
