...
export const cuentabancocllientesTool: Tool = {
  name: 'get_cuentabancoclientes',
  description: 'Obtener cuentas bancarias de clientes con paginación y filtros',
  inputSchema: {
    type: 'object',
    properties: {
      limit: {
...
export async function handleCuentabancocllientesTool(
  ...
  try {
    const result = await client.getWithPagination<CuentaBancoCliente>(
      '/cuentabancoclientes',
      limit,
      offset,
      additionalParams
