...
export const logmessagesTool: Tool = {
  name: 'get_logmessages',
  description: 'Obtener mensajes de log del sistema con paginación y filtros',
  inputSchema: {
    type: 'object',
    properties: {
      limit: {
...
export async function handleLogmessagesTool(
  ...
  try {
    const result = await client.getWithPagination<LogMessage>(
      '/logmessages',
      limit,
      offset,
      additionalParams
