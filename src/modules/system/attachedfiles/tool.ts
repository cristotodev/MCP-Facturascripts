...
export const attachedfilesTool: Tool = {
  name: 'get_attachedfiles',
  description: 'Obtener archivos adjuntos con paginación y filtros',
  inputSchema: {
    type: 'object',
    properties: {
      limit: {
...
export async function handleAttachedfilesTool(
  ...
  try {
    const result = await client.getWithPagination<AttachedFile>(
      '/attachedfiles',
      limit,
      offset,
      additionalParams
