...
export const apikeyesTool: Tool = {
  name: 'get_apikeyes',
  description: 'Obtener claves API con paginación y filtros',
  inputSchema: {
    type: 'object',
    properties: {
      limit: {
...
export async function handleApikeyesTool(
  ...
  try {
    const result = await client.getWithPagination<ApiKey>(
      '/apikeyes',
      limit,
      offset,
      additionalParams
