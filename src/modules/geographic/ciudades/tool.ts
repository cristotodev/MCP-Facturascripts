...
export const ciudadesTool: Tool = {
  name: 'get_ciudades',
  description: 'Obtener ciudades con paginación y filtros',
  inputSchema: {
    type: 'object',
    properties: {
      limit: {
...
export async function handleCiudadesTool(
  ...
  try {
    const result = await client.getWithPagination<Ciudad>(
      '/ciudades',
      limit,
      offset,
      additionalParams
