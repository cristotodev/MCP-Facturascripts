...
export const codigopostalesTool: Tool = {
  name: 'get_codigopostales',
  description: 'Obtener códigos postales con paginación y filtros',
  inputSchema: {
    type: 'object',
    properties: {
      limit: {
...
export async function handleCodigopostalesTool(
  ...
  try {
    const result = await client.getWithPagination<CodigoPostal>(
      '/codigopostales',
      limit,
      offset,
      additionalParams
