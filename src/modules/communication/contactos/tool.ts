...
export const contactosTool: Tool = {
  name: 'get_contactos',
  description: 'Obtener contactos con paginación y filtros',
  inputSchema: {
    type: 'object',
    properties: {
      limit: {
...
export async function handleContactosTool(
  ...
  try {
    const result = await client.getWithPagination<Contacto>(
      '/contactos',
      limit,
      offset,
      additionalParams
