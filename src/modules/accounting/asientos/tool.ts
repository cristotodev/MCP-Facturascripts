...
import type { Asiento } from '../../../types/facturascripts.js';

export const asientosTool: Tool = {
  name: 'get_asientos',
  description: 'Obtener asientos contables con paginación y filtros',
  inputSchema: {
    type: 'object',
    properties: {
      limit: {
...
export async function handleAsientosCall(
  ...
  try {
    ...
    const result = await client.getWithPagination<Asiento>(
      '/asientos',
      limit,
      offset,
      additionalParams
